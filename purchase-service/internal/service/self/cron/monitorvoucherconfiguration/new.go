package monitorvoucherconfiguration
...
type Cron struct {
	ctx    context.Context
	logger *zap.Logger
	cfg    *config.MonitorVoucherConfigurationCron
...
func NewCron(
	ctx context.Context, logger *zap.Logger, cfg *config.MonitorVoucherConfigurationCron,
